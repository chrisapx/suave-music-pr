...
const AboutUs = () => {
  ...
  const team = [
    ...
    { name: 'Tela Wangeci', image: 'images/Tela Wangeci pic.jpg', title: 'Ops & Partnerships', description: 'tela@suavemusicpr.com' },
  ...
  return (
    <div className="relative h-screen overflow-auto">
      ...
      <section className='mb-16'>
        ...
        <div className="py-10 overflow-hidden text-center border-t">
